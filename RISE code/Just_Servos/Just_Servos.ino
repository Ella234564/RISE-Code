/**
 * This is a simple block of code that turns the servos 180 degrees back and forth. The LCD is not displayed.
 */
...
void setup(){                                   //Setup runs 1 time to get things ready
  servo1.attach(pin);                             //Servo is initialized to pin 0 from the earlier line of code
}
